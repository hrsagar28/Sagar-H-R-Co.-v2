...
import { calculateRegimeTax, DEFAULT_CONFIG } from './useTaxCalculation';
...
describe('Tax Calculation Logic', () => {
  ...
  describe('New Regime', () => {
    it('should apply Standard Deduction of 75k', () => {
      ...
      const result = calculateRegimeTax('new', incomes, deds, 'below60', DEFAULT_CONFIG);
  ...
  describe('Old Regime', () => {
    it('should apply Standard Deduction of 50k and Chapter VI-A deductions', () => {
        ...
        const result = calculateRegimeTax('old', incomes, deds, 'below60', DEFAULT_CONFIG);
    ...
    it('should allow higher basic exemption limit for Senior Citizens', () => {
        ...
        const resultNormal = calculateRegimeTax('old', incomes, deds, 'below60', DEFAULT_CONFIG);
        ...
        const resultSenior = calculateRegimeTax('old', incomes, deds, '60to80', DEFAULT_CONFIG);
  ...
  describe('Surcharge & Marginal Relief', () => {
      it('should apply surcharge when income exceeds 50L', () => {
          ...
          const result = calculateRegimeTax('new', inputs.incomes, inputs.deds, 'below60', DEFAULT_CONFIG);
