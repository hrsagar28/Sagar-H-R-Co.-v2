...
export const SERVICE_DETAILS: Record<string, ServiceDetailContent> = {
  gst: {
    ...
    longDescription:
      'We provide services for GST registration and filing of returns. We assist in the preparation and submission of necessary documents to the GST authorities.',
    features: [
      ...
      { title: 'Return Filing', description: 'Filing of GSTR-1, GSTR-3B, and other periodic returns.' },
      {
        ...
        description: 'Filing of Annual Return (GSTR-9) and Reconciliation Statements (GSTR-9C).',
      },
  ...
  'income-tax': {
    ...
    longDescription:
      'We assist in the filing of Income Tax Returns and compliance with applicable tax provisions for various entities.',
    features: [
    ...
    features: [
      {
        ...
        description: 'Filing of annual returns and financial statements (Forms AOC-4, MGT-7).',
      },
      ...
      { title: 'Event-Based Filings', description: 'Filings related to changes in directorship or registered office.' },
      {
        ...
        description: 'Assistance with documentation for board meetings and resolutions.',
      },
    ],
  },
  litigation: {
    ...
    longDescription:
      'We represent clients in assessment and appellate proceedings before tax authorities and tribunals.',
    features: [
  ...
  bookkeeping: {
    ...
    longDescription:
      'We provide services for the maintenance of books of accounts and preparation of financial statements.',
    features: [
