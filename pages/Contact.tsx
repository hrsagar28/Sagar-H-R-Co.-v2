...
const Contact: React.FC = () => {
  ...
  // Form State for controlled inputs (still needed for UI, even if not using fetch)
  ...
  return (
    <div className="pt-32 md:pt-40 pb-20 min-h-screen px-4 md:px-6 bg-brand-bg">
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 mb-20">
          ...
          <div>
            <h1 className="text-5xl md:text-8xl font-heading font-bold text-brand-dark mb-8 md:mb-10 tracking-tighter">Let's <br/><span className="text-brand-moss">Connect.</span></h1>
            <p className="text-brand-stone text-lg md:text-xl mb-10 md:mb-16 font-medium max-w-md leading-relaxed">
              Ready to optimize your financial strategy? Reach out to us for a consultation.
            </p>
            
            {/* Contact Details Card - Light Theme & Static (Removed Sticky) */}
          ...
          <div className="bg-brand-surface p-8 md:p-12 rounded-[2.5rem] md:rounded-[3rem] border border-brand-border shadow-2xl shadow-brand-dark/5">
            ...
            {/* Standard HTML Form Submission (No AJAX) */}
            <form 
            ...
            >
              ...
              {/* Remove _next to allow FormSubmit to show its default success/activation page for debugging */}
              ...
              <div className="flex flex-col gap-2 relative" ref={dropdownRef}>
                ...
                {/* HIDDEN INPUT to actually send the subject value in the POST request */}
