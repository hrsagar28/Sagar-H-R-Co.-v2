        ...
        <div className="bg-brand-surface p-8 md:p-12 rounded-[2.5rem] border border-brand-border shadow-sm">
          ...
          <div className="space-y-10 text-brand-stone font-medium leading-relaxed text-lg">
            ...
            <section>
              ...
              <p className="mb-4">
                <strong>Local form drafts:</strong> If you accept optional cookies, contact and application forms may temporarily save draft details in your browser localStorage so you can resume an incomplete form. Contact form drafts may include details such as name, email, phone number, company, and message content, and currently expire after 7 days. Careers application drafts may include details such as name, date of birth, phone number, email address, qualifications, prior employment details, and application responses, and currently expire after 14 days. If you decline optional cookies, we do not store these drafts and any unsaved draft data may be cleared when you leave the page.
              </p>
              <p className="mb-4">
