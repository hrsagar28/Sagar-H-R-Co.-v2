...
const Resources: React.FC = () => {
  ...
  const calculateTax = (annualIncome: number, age: string, reg: 'new' | 'old', deds: any) => {
    ...
    if (reg === 'new') {
      ...
      // If income > 7L, normal slab applies on taxable income
      // 0-3L: Nil
      // 3-7L: 5%
      // 7-10L: 10%
      // 10-12L: 15%
    ...
    <div className="pt-32 md:pt-40 pb-20 px-4 md:px-6 bg-brand-bg min-h-screen">
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="mb-16 md:mb-20">
          <h1 className="text-5xl md:text-8xl font-heading font-bold text-brand-dark mb-6 tracking-tighter">
            Client Resources <span className="text-brand-moss">Hub</span>
          </h1>
          <p className="text-xl text-brand-stone font-medium max-w-2xl leading-relaxed">
