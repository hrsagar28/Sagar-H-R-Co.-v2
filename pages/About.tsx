...
const About: React.FC = () => {
  return (
    <div className="min-h-screen bg-brand-bg selection:bg-brand-moss selection:text-white">
      ...
      {/* 1. Hero Section - Clean & Architectural */}
      <section className="pt-32 md:pt-48 pb-20 px-4 md:px-6 relative bg-grid border-b border-brand-border/50">
        <div className="container mx-auto max-w-7xl relative z-10">
           <div className="max-w-5xl">
              ...
              <h1 className="text-6xl md:text-8xl lg:text-9xl font-heading font-bold text-brand-dark tracking-tighter leading-[0.9] mb-10 animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
                More Than <br/>
                <span className="font-serif italic font-normal text-brand-stone opacity-60">Just Numbers.</span>
              </h1>
           </div>
           
           <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-end animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
              <div className="lg:col-span-7">
                 <div className="relative aspect-[16/9] rounded-[2.5rem] overflow-hidden border border-brand-border bg-brand-surface shadow-2xl">
                    <div className="absolute inset-0 bg-brand-moss/5"></div>
                    {/* Abstract Geometric Composition */}
                    <div className="absolute top-0 right-0 w-full h-full opacity-30">
                        <div className="absolute top-10 right-10 w-32 h-32 border-4 border-brand-dark/10 rounded-full"></div>
                        <div className="absolute bottom-10 left-10 w-64 h-64 bg-brand-moss/10 rounded-full mix-blend-multiply filter blur-2xl"></div>
                    </div>
      ...
      {/* 2. Mission Statement - Dark Mode Contrast */}
