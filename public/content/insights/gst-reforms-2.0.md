...
The cornerstone of GST 2.0 is the proposed reduction in the number of tax slabs. The current structure of 5%, 12%, 18%, and 28% is likely to be replaced by a two-slab system: a "merit rate" of 5% for essential goods and a "standard rate" of 18% for most other items. The 12% and 28% slabs are expected to be eliminated, with items moving to the new, more streamlined rates.
...
By reducing compliance burdens, freeing up capital, and boosting consumer demand, GST 2.0 is poised to provide a significant impetus to the Indian economy. The reforms are expected to be discussed in the upcoming GST Council meeting and could be implemented soon.
